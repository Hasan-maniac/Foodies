...
<html>
    ...
    $sq="select * from orderr ,customer, itemm where customer.cust_id=orderr.cust_id AND orderr.item_id=itemm.item_id AND or_status='Processing' ";
    $ret=mysql_query($sq);
	...
	<table width="80%" align="center" border="1" bordercolor="#666666"<pre></pre>
			<tr>
				...
				<td width="5%" id="form" align="center"><h5>Status</h5></td>
                         ...
                         <form action="notun.php" method="post" >
