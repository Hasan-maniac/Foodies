...
<html>
    ...
    $sq="select * from orderr ,customer, itemm where customer.cust_id=orderr.cust_id AND orderr.item_id=itemm.item_id AND or_status='Approved' ";
    $ret=mysql_query($sq);
...
echo '
			...
			<tr> 
				...
				<td width="5%" align="center"> '. $x['item_name'].'</td>
                          ...
                          <td width="5%" align="center">Accepted</td>
        </tr>';
