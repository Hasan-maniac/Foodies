...
<html>
    ...
    $sq="select * from orderr ,customer, itemm where customer.cust_id=orderr.cust_id AND orderr.item_id=itemm.item_id AND or_status='Rejected' ";
    $ret=mysql_query($sq);
...
echo '
                        ...
                        <input type="hidden" name="id_1[]" value="'.$x['order_id'].'"/>
			<tr> 
				...
				<td width="5%" align="center"> '. $x['item_name'].'</td>
                          ...
                          <td width="5%" align="center">Rejected</td>
        </tr>';
